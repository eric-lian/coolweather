...
public class CommonUtil {
	 ...
	 * @param titleStr 标题
	 * @param positiveStr 点击确定的字符
	 * @param onClickListener 点击positivie后的点击事件
	 */
	public static void showInfoDialog(Context context, String message,
	...
	/**
	 * @param paramString 需要转化为md5的值，将md5的值转化为16进制
	 * @return
	 */
...
//						得到当前的网络的详细信息
	...
	public static boolean hasToken(Context ct) {
		String token = SharedPreferencesUtil.getValue(ct, "token", "");
	...
	public static void writeOutline(Object object ){
